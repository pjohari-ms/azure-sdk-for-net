...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraClusterResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual async Task<ArmOperation<CommandPublicResource>> CassandraClusterInvokeCommandAsynchronouslyAsync(WaitUntil waitUntil, CassandraCommandPostBody body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));

            using var scope = _cassandraClusterClientDiagnostics.CreateScope("CassandraClusterResource.CassandraClusterInvokeCommandAsynchronously");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual ArmOperation<CommandPublicResource> CassandraClusterInvokeCommandAsynchronously(WaitUntil waitUntil, CassandraCommandPostBody body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
