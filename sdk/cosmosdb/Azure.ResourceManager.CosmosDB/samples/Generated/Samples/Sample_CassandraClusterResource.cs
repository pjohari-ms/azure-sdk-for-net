...
["owner"] = "mike",
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CassandraClusterInvokeCommandAsynchronously_CosmosDBManagedCassandraCommandAsync()
        {
            ...
            ArmOperation<CommandPublicResource> lro = await cassandraCluster.CassandraClusterInvokeCommandAsynchronouslyAsync(WaitUntil.Completed, body);
